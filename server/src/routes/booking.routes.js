...
router.patch('/:id/update-status-invite', bookingController.updateStatusInvite);
router.patch('/:id/update-invite', bookingController.updateInvite);
...
router.get('/get-invites', bookingController.findInvitesByUser);
router.get('/get-invite', bookingController.findInviteById);
router.get('/get-booking-complete', bookingController.getBookingComplete);
router.get('/local/get-bookings-complete', bookingController.getLocalBookingComplete);
