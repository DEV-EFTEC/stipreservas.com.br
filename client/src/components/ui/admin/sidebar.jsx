    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-slate-800 flex min-h-svh w-full",
            className
          )}
          {...props}>
          {children}
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-slate-800 flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}>
        {children}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-slate-800 w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
...
function SidebarRail({
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-slate-800-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex",
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-slate-800-border mx-2 w-auto", className)}
      {...props} />
  );
}
