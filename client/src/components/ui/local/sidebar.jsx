    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-amber-800 flex min-h-svh w-full",
            className
          )}
          {...props}>
          {children}
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-amber-800 flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}>
        {children}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-amber-800 w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          className="bg-amber-800 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm">
          {children}
        </div>
      </div>
    </div>
...
function SidebarRail({
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-amber-800-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex",
        "in-data-[side=left]:cursor-w-resize in-data-[side=right]:cursor-e-resize",
        "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
        "hover:group-data-[collapsible=offcanvas]:bg-amber-800 group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full",
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-amber-800-border mx-2 w-auto", className)}
      {...props} />
  );
}
