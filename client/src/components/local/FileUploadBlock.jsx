          ...
          >
            <div className="flex items-center justify-start gap-3">
              ...
              <span className="text-sm text-gray-700 truncate">
                {value ? getFileNameFromFirebaseUrl(value).length > 15 ? getFileNameFromFirebaseUrl(value).slice(0, 18) + '...' : getFileNameFromFirebaseUrl(value) : fileName.length > 15 ? fileName.slice(0, 13) + '...' : fileName}
              </span>
            </div>
